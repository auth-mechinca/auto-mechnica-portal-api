...
| `test/categories.test.ts` | That two spellings of one category cannot both exist, and that renaming reaches every part |
| `test/brands.test.ts` | The same for brands, in their own module |
